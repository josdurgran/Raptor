...
%>
	...
	<% if(request.getParameter("condicion") == null){ %>
		...
		<% out.print(new empresa().menuEmpresa(request, "emp.empr_nombre like '%%'")); %>
	
	<% }else{ %>
	
		<% out.print(new empresa().menuEmpresa( request, "upper("+request.getParameter("campo")+") like upper('%"+request.getParameter("valor")+"%')" )); %>

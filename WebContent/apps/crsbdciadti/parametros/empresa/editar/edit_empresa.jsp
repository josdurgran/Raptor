...
<form id="filtro" name="filtro" method="post" action="./menu_empresa.jsp" onsubmit="" target="empr_menu">
...
<option value="EMPR_NOMBRE">DENOMINACIÓN</option>
<option value="EMPR_SIGLA">SIGLA</option>
</select>
...
<iframe src="menu_empresa.jsp" width="30%" class="interna"  frameBorder="0" name="empr_menu" /></iframe>
<iframe src="deta_empresa.jsp" width="69%" class="interna" frameBorder="0" name="empr_contenido" /></iframe>

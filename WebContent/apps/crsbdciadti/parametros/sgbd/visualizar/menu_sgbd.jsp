...
%>
	...
	<% if(request.getParameter("condicion") == null){ %>
		...
		<% out.print(new sgbd().menuSgbd(request, "sgb.sgbd_estado like '%%'")); %>
	
	<% }else{ %>
	
		<% out.print(new sgbd().menuSgbd( request, "upper("+request.getParameter("campo")+") like upper('%"+request.getParameter("valor")+"%')" )); %>

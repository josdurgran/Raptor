...
%>
	...
	<% if(request.getParameter("condicion") == null){ %>
		...
		<% out.print(new baseDatos().menuBaseDatos(request, "bda.bada_nombre like '%%'")); %>
	
	<% }else{ %>
	
		<% out.print(new baseDatos().menuBaseDatos( request, "upper("+request.getParameter("campo")+") like upper('%"+request.getParameter("valor")+"%')" )); %>

...
<form id="filtro" name="filtro" method="post" action="./menu_sgbd.jsp" onsubmit="" target="sgbd_menu">
...
<option value="TISG_NOMBRE">SGBD</option>
<option value="SERV_IPV4">IPV4</option>
<option value="SERV_HOST">HOST</option>
<option value="SGBD_ESTADO">ESTADO</option>
<option value="SGBD_PUERTO">PUERTO</option>
</select>
...
<iframe src="menu_sgbd.jsp" width="30%" class="interna"  frameBorder="0" name="sgbd_menu" /></iframe>
<iframe src="deta_sgbd.jsp" width="69%" class="interna" frameBorder="0" name="sgbd_contenido" /></iframe>

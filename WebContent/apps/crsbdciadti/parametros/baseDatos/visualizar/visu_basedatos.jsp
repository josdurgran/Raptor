...
<form id="filtro" name="filtro" method="post" action="./menu_bada.jsp" onsubmit="" target="bada_menu">
...
<option value="EMP.EMPR_SIGLA||EMP.EMPR_NOMBRE">EMPRESA</option>
<option value="BDA.BADA_NOMBRE">BASE DE DATOS</option>
<option value="BDA.BADA_DESCRIPCION">DESCRIPCION</option>
<option value="SER.SERV_IPV4||COALESCE(SER.SERV_HOST, '')">IPV4 - HOST</option>
</select>
...
<iframe src="menu_bada.jsp" width="30%" class="interna"  frameBorder="0" name="bada_menu" /></iframe>
<iframe src="deta_bada.jsp" width="69%" class="interna" frameBorder="0" name="bada_contenido" /></iframe>
